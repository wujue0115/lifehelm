export default {
  ...
  list: {
    ...
    exportPrefixAsterisk: 'Asterisk (*)',
    exportPrefixBullet: 'Bullet (•)',
    exportPrefixNone: 'None',
    exportDatePositionBefore: 'Date before title',
  ...
  dateFilter: {
    ...
    groupCurrent: 'Current period',
    groupPast: 'Past period',
    groupCustom: 'Custom range',
    preset: {
      today: 'Today',
      thisWeek: 'This week',
