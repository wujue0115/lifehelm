export default {
  ...
  list: {
    ...
    allPriority: '所有優先級',
    allTags: '所有標籤',
    filterSelectedCount: '已選 {count} 項',
    ...
    exportPrefixAsterisk: '星號 (*)',
    exportPrefixBullet: '項目點 (•)',
    exportPrefixNone: '無',
    exportDatePositionBefore: '日期在標題前',
  ...
  colorSettings: {
    ...
    scopeGlobal: '全域',
    scopeView: '此檢視',
    scopeGlobalHint: '套用到所有地方——每個 List、Board、Calendar。',
    scopeViewHint: '只套用到這個小工具，會蓋過全域顏色（若兩者都有設定）。',
    status: '狀態',
    priority: '優先級',
    tags: '標籤',
    none: '無顏色',
